...
export class ConferenceHighlightsPage {
  ...
  'State of the Art Lectures by Pioneers:', 
  'Goran Klintmalm, Mohamed Rela, Abhinav Humar', 
  'Workshops', 
  'Minimally Invasive Liver Surgery: KW Lee, Olivier Soubrane, Vivek Vij', 
  'SALT Workshop on ROTEM: Klaus Görlinger', 
